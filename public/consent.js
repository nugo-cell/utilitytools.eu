...
(function () {
  ...
  function buildBanner() {
    ...
    bar.innerHTML = ''
      ...
      +   'No analytics tracking from us — just the ads. '
  ...
  function buildModal() {
    ...
    wrap.innerHTML = ''
      ...
      +   '<p>UtilityTools.eu is built by an independent EU developer so you can use <strong>{{TOOL_COUNT}} free, privacy-friendly tools</strong> with no signup and no analytics tracking.</p>'
