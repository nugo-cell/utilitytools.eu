...
(function () {
  ...
  function buildModal() {
    ...
    wrap.innerHTML = ''
      ...
      +   '<p>UtilityTools.eu is built by an independent EU developer so you can use <strong>120 free, privacy-friendly tools</strong> with no signup and no analytics tracking.</p>'
